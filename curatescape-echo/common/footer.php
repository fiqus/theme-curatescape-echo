	...
	<footer class="primary">
	    <div class="max-content-width inner-padding" style="display: flex;">
				<div class="legend">
					<p>El trabajo que realizamos es gracias a la gente que aporta sus historias. Si tenés material que pueda ayudarnos nos podés escribir a <a href="mailto:archivosdelsur@gmail.com">archivosdelsur@gmail.com</a></p>
				</div>
